...
import com.lildar.myReview.domain.model.Greeting;
...
public class LibraryController {
    ...
    @GetMapping("/library")
    public String profile( @RequestParam(value = "search", required = false) String search, Model model){
        if(search!=null){
            List<Film> films= filmService.getFilmsByName("%"+search+"%");
